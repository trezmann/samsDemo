package de.test.samsdemo.web.rest;

import de.test.samsdemo.config.Constants;
import de.test.samsdemo.SamsDemoApp;
import de.test.samsdemo.domain.Authority;
import de.test.samsdemo.domain.User;
import de.test.samsdemo.repository.AuthorityRepository;
import de.test.samsdemo.repository.UserRepository;
import de.test.samsdemo.security.AuthoritiesConstants;
import de.test.samsdemo.service.MailService;
import de.test.samsdemo.service.dto.UserDTO;
import de.test.samsdemo.web.rest.errors.ExceptionTranslator;
import de.test.samsdemo.web.rest.vm.KeyAndPasswordVM;
import de.test.samsdemo.web.rest.vm.ManagedUserVM;
import de.test.samsdemo.service.UserService;
...
@SpringBootTest(classes = SamsDemoApp.class)
