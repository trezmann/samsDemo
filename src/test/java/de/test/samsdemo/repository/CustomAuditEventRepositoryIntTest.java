package de.test.samsdemo.repository;

import de.test.samsdemo.SamsDemoApp;
import de.test.samsdemo.config.Constants;
import de.test.samsdemo.config.audit.AuditEventConverter;
import de.test.samsdemo.domain.PersistentAuditEvent;
...
import static de.test.samsdemo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
